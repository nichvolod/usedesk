...
1. [Install](https://vtex.io/docs/recipes/store/installing-an-app) the `acceleratorusedesk.usedeskwidget@1.x` app in the desired account using your terminal. You can also install the app through the VTEX App Store.
